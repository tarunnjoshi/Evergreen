  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        <h2 className="text-sm title-font text-gray-500 tracking-widest">Evergreen ecommerce</h2>
        ...
        <div className="flex">
          ...
          <button onClick={()=>{addToCart(slug, 1, 499, 'wear the code(XL, Red)','XL', 'Red' )}} className="flex ml-8 text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded">Add to cart</button>
          <button className="flex ml-8 text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded">Buy now</button>
        ...
        <div className="pin mt-6 flex space-x-3 text-sm">
          ...
          <button onClick={checkservicability} className='flex ml-8 text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded'>Pincode</button>
        </div>
