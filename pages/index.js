...
export default function Home() {
  return (
    ...
    <div>
      <img className='w-full h-3/6' src='/banner1.jpg' alt='' width={1032 } height={300}/>
    </div>
    <section className="text-gray-600 body-font">
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Evergreen</h1>
      <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Whatever You want.</p>
    </div>
